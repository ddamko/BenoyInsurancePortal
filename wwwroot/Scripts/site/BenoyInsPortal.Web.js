...
(function (BenoyInsPortal) {
    ...
    })(Administration = BenoyInsPortal.Administration || (BenoyInsPortal.Administration = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var Administration;
    (function (Administration) {
...
(function (BenoyInsPortal) {
    ...
    })(BasicSamples = BenoyInsPortal.BasicSamples || (BenoyInsPortal.BasicSamples = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = BenoyInsPortal.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = BenoyInsPortal.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = BenoyInsPortal.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (BenoyInsPortal) {
    ...
    })(Common = BenoyInsPortal.Common || (BenoyInsPortal.Common = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var Common;
...
(function (BenoyInsPortal) {
    ...
    })(Membership = BenoyInsPortal.Membership || (BenoyInsPortal.Membership = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var Membership;
...
(function (BenoyInsPortal) {
    ...
    })(Northwind = BenoyInsPortal.Northwind || (BenoyInsPortal.Northwind = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var Northwind;
...
(function (BenoyInsPortal) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'BenoyInsPortal.Northwind.Gender', 'BenoyInsPortal.Northwind.Entities.Gender');
    })(Northwind = BenoyInsPortal.Northwind || (BenoyInsPortal.Northwind = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
...
(function (BenoyInsPortal) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = BenoyInsPortal.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = BenoyInsPortal.LanguageList || (BenoyInsPortal.LanguageList = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
...
(function (BenoyInsPortal) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = BenoyInsPortal.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = BenoyInsPortal.ScriptInitialization || (BenoyInsPortal.ScriptInitialization = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var Administration;
...
(function (BenoyInsPortal) {
    ...
    BenoyInsPortal.BasicProgressDialog = BasicProgressDialog;
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new BenoyInsPortal.BasicProgressDialog();
...
(function (BenoyInsPortal) {
    ...
    })(DialogUtils = BenoyInsPortal.DialogUtils || (BenoyInsPortal.DialogUtils = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var Common;
...
(function (BenoyInsPortal) {
    ...
    BenoyInsPortal.StaticTextBlock = StaticTextBlock;
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                BenoyInsPortal.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(BenoyInsPortal.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(BenoyInsPortal.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(BenoyInsPortal.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        BenoyInsPortal.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: BenoyInsPortal.Authorization.userDefinition.DisplayName,
...
(function (BenoyInsPortal) {
    ...
    (function (Northwind) {
        ...
        }(BenoyInsPortal.Common.GridEditorDialog));
...
(function (BenoyInsPortal) {
    ...
    (function (Northwind) {
        ...
        }(BenoyInsPortal.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return BenoyInsPortal.LanguageList.getValue();
            };
...
(function (BenoyInsPortal) {
    ...
    })(Authorization = BenoyInsPortal.Authorization || (BenoyInsPortal.Authorization = {}));
})(BenoyInsPortal || (BenoyInsPortal = {}));
var BenoyInsPortal;
(function (BenoyInsPortal) {
    var BasicSamples;
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(BenoyInsPortal.Northwind.ProductDialog));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(BenoyInsPortal.Northwind.ProductGrid));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: BenoyInsPortal.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: BenoyInsPortal.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new BenoyInsPortal.Northwind.OrderDialog();
                        ...
                        var chai = BenoyInsPortal.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = BenoyInsPortal.Northwind.EmployeeRow.getLookup().items
        ...
        }(BenoyInsPortal.Northwind.OrderGrid));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(BenoyInsPortal.Northwind.OrderDialog));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    BenoyInsPortal.Northwind.CategoryService.Retrieve({
        ...
        }(BenoyInsPortal.Northwind.CategoryDialog));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(BenoyInsPortal.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(BenoyInsPortal.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new BenoyInsPortal.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                BenoyInsPortal.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(BenoyInsPortal.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    BenoyInsPortal.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(BenoyInsPortal.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(BenoyInsPortal.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    BenoyInsPortal.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return BenoyInsPortal.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return BenoyInsPortal.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return BenoyInsPortal.Northwind.OrderService.baseUrl; };
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(BenoyInsPortal.Northwind.SupplierDialog));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(BenoyInsPortal.Northwind.SupplierGrid));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return BenoyInsPortal.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return BenoyInsPortal.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return BenoyInsPortal.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return BenoyInsPortal.Northwind.OrderService.baseUrl; };
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    BenoyInsPortal.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(BenoyInsPortal.Northwind.CustomerDialog));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(BenoyInsPortal.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = BenoyInsPortal.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return BenoyInsPortal.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new BenoyInsPortal.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(BenoyInsPortal.Northwind.OrderDetailDialog));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(BenoyInsPortal.Northwind.OrderDetailsEditor));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return BenoyInsPortal.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return BenoyInsPortal.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return BenoyInsPortal.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return BenoyInsPortal.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        ...
        }(BenoyInsPortal.Common.BulkServiceAction));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return BenoyInsPortal.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return BenoyInsPortal.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return BenoyInsPortal.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(BenoyInsPortal.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new BenoyInsPortal.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new BenoyInsPortal.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new BenoyInsPortal.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (BenoyInsPortal) {
    ...
    BenoyInsPortal.SelectableEntityGrid = SelectableEntityGrid;
})(BenoyInsPortal || (BenoyInsPortal = {}));
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return BenoyInsPortal.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return BenoyInsPortal.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return BenoyInsPortal.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(BenoyInsPortal.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = BenoyInsPortal.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            BenoyInsPortal.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return BenoyInsPortal.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return BenoyInsPortal.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return BenoyInsPortal.Northwind.ProductService.baseUrl; };
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return BenoyInsPortal.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return BenoyInsPortal.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return BenoyInsPortal.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return BenoyInsPortal.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (BenoyInsPortal) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return BenoyInsPortal.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return BenoyInsPortal.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return BenoyInsPortal.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=BenoyInsPortal.Web.js.map